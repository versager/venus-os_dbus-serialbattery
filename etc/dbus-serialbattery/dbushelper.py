...
class DbusHelper:
    ...
    def publish_dbus(self):
        ...
        self._dbusservice["/Info/ChargeModeDebugFloat"] = (
            self.battery.charge_mode_debug_float
        )
        self._dbusservice["/Info/ChargeModeDebugBulk"] = (
            self.battery.charge_mode_debug_bulk
        )
