...
def init_max(self):
    ...
    # over voltage clear thr 3.5V/.305mV <<2
    spi_xfer_MAX17(0, 0x1F, ovc << 2)
    ...
    # under voltage clear thr 2.6V/.305mV <<2
    spi_xfer_MAX17(0, 0x21, uvc << 2)
...
def err_dec(st_wd1, st_wd2, fema1, self):
    ...
    if st_wd1 & 0x800 > 0:
        ...
        self.protection.voltage_cell_low = True
    else:
        self.protection.voltage_cell_low = False
    if st_wd1 & 0x1000 > 0:
        err_no = 3  # overvoltage
        err_msg = "Cell Overvoltage"
        self.protection.voltage_cell_high = True
    else:
        self.protection.voltage_cell_high = False
    if st_wd1 & 0x2000 > 0:
